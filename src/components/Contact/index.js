  ...
  const [validForm, setValidForm] = useState(false);
    ...
    return (
        ...
        <div className="contact-page">
            ...
            <div className="contact-form">If you're running into technical problems, or would like to just drop us a line, use the contact form below and we'll get back to you as soon as we can!</div>
